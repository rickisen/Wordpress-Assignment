...
<link rel="alternate" type="application/rss+xml" title="DarkShells &raquo; Search Results for &#8220;file manager&#8221; Feed" href="http://wordpress.local/search/file+manager/feed/rss2/" />
    ...
    <div class="home">
      ...
      <div class="float-right"> <li id="search-7" class="widget widget_search"><form role="search" method="get" id="searchform" class="searchform" action="http://wordpress.local/">
				<div>
					...
					<input type="text" value="file manager" name="s" id="s" />
  ...
  <br>
        ...
        <div class="arrows flex-container">
          <span class="leftside-arrows">
            ...
            <span class="arrow">Ranger</span>
          </span>
          <span class="no-arrow"> http://wordpress.local/clireview/ranger/ </span>
...
<!-- Cached page generated by WP-Super-Cache on 2016-02-15 15:27:41 -->
