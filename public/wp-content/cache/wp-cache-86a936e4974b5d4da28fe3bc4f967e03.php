...
<link rel="alternate" type="application/rss+xml" title="DarkShells &raquo; Cmus Comments Feed" href="http://wordpress.local/clireview/cmus/feed/" />
...
<link rel='prev' title='Ranger' href='http://wordpress.local/clireview/ranger/' />
<link rel='next' title='Nvlc' href='http://wordpress.local/clireview/nvlc/' />
<meta name="generator" content="WordPress 4.4.2" />
<link rel="canonical" href="http://wordpress.local/clireview/cmus/" />
<link rel='shortlink' href='http://wordpress.local/?p=72' />
<link rel="alternate" type="application/json+oembed" href="http://wordpress.local/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fwordpress.local%2Fclireview%2Fcmus%2F" />
<link rel="alternate" type="text/xml+oembed" href="http://wordpress.local/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fwordpress.local%2Fclireview%2Fcmus%2F&#038;format=xml" />
    <style type="text/css">
...
<div class="content">
  ...
  <a href="http://wordpress.local/clireview/cmus/"><h2> Cmus</h2></a>
...
<p>It has some quirks though. Like the default theme is a bit too much in love with changing the background of the text instead of just changing the text color. But I fixed that pretty fast. And it was also a bit weird that  the main screen didn&#8217;t jump to the currently playing song by default. But it was quickly fixed by adding a single line to the config. But yeah, that should really be default behavior.</p>
<p>As usual if you want my config, they are in my dotfiles repo at github.</p>
  <p> 
    <a href="http://wordpress.local/author/rickisen/" title="Posts by rickisen" rel="author">rickisen</a>  2016-Feb-Mon 15:30  </p> <br>

  <div class="taxonomies">Program Type: <a href="http://wordpress.local/programtype/music-player/">Music player</a>.<br>Recomendation: <a href="http://wordpress.local/recommendation/neat/">neat</a>.</div> 
        ...
        <div class="arrows flex-container">
          <span class="leftside-arrows">
            ...
            <span class="arrow">Cmus</span>
          </span>
          <span class="no-arrow"> http://wordpress.local/clireview/cmus/ </span>
...
<!-- Cached page generated by WP-Super-Cache on 2016-02-15 15:25:49 -->
